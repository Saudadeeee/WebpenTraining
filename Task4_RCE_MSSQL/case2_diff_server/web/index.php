<?php
try {
    $db_host = getenv("DB_HOST") ?: (getenv("MSSQL_HOST") ?: "task4-case2-mssql");
...
<head>
    ...
    <title>Store Admin - Case 2</title>
    <style>
...
<body>
    <div class="wrap">
        <h1>Store Admin Dashboard (Case 2)</h1>
        <p>Product lookup and internal maintenance execution for remote deployment.</p>
